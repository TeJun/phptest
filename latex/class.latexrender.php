...
class LatexRender {
    ...
    var $_tmp_filename;
	var $_image_format = "png"; //change to git, png if you prefer
    ...
    // add by soar, for set formula_density
	function setFormulaDensity($size) {
	    $this->_formula_density = $size;
//		echo "SetDensity to ".$this->_formula_density;
	}
    ...
    function getFormulaURL($latex_formula) {
        ...
        //$filename = $formula_hash.".".$this->_image_format;	//mark by soar
		//add density to file name, add by soar, 20130326
        $filename = $formula_hash.".".$this->_formula_density.".".$this->_image_format;
    ...
    function renderLatex($latex_formula) {
        ...
        //$filename = $this->getPicturePath()."/".$latex_hash.".".$this->_image_format; //mark by soar
		//add density to file name, add by soar, 20130326
        $filename = $this->getPicturePath()."/".$latex_hash.".".$this->_formula_density.".".$this->_image_format;
